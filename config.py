...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "generation_defaults": {  # Default parameters for TTS audio generation.
        "temperature": 0.90,  # Controls randomness. Raised from 0.8: higher temperature introduces
                              # enough variation to break repetition in parallel prose (Dickens etc.)
                              # without causing instability. Simon confirmed 1.11 works; 0.90 is a
                              # conservative step that handles most cases.
        ...
        "repetition_penalty": 1.5,  # Penalises repeating recent tokens. Raised from 1.35: chunks
                                    # with 4+ parallel constructions (e.g. Tale of Two Cities opening)
                                    # still failed at 1.35 + temperature 0.8.
    },
